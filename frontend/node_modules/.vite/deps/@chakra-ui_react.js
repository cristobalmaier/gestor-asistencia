...
function getValueTransition(transition2, key) {
  return (transition2 == null ? void 0 : transition2[key]) ?? (transition2 == null ? void 0 : transition2["default"]) ?? transition2;
}
...
function PopChild({ children, isPresent: isPresent2, anchorX, root }) {
  ...
  return (0, import_jsx_runtime6.jsx)(PopChildMeasure, { isPresent: isPresent2, childRef: ref, sizeRef: size, children: React2.cloneElement(children, { ref: composedRef }) });
}
...
function useVisualElement(Component3, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react33.useRef)(Boolean(optimisedAppearId) && !((_a2 = window.MotionHandoffIsComplete) == null ? void 0 : _a2.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
    if (!visualElement)
      return;
...
function getProjectionFunctionality(props) {
  ...
  return {
    MeasureLayout: (drag2 == null ? void 0 : drag2.isEnabled(props)) || (layout3 == null ? void 0 : layout3.isEnabled(props)) ? combined.MeasureLayout : void 0,
...
var VisualElementDragControls = class {
  ...
  resolveConstraints() {
    ...
    const layout3 = this.visualElement.projection && !this.visualElement.projection.layout ? this.visualElement.projection.measure(false) : (_a2 = this.visualElement.projection) == null ? void 0 : _a2.layout;
...
var ToastProvider = (props) => {
  const state = (0, import_react58.useSyncExternalStore)(
...
function useDescendant(options) {
  ...
  const [index, setIndex] = (0, import_react62.useState)(-1);
...
var AvatarGroup = forwardRef(
  function AvatarGroup2(props, ref) {
    ...
    const clones = reversedChildren.map((child, index) => {
      ...
      return (0, import_react76.cloneElement)(child, compact2(childProps));
    });
    const groupStyles = {
      display: "flex",
      alignItems: "center",
...
var Breadcrumb = forwardRef(
  function Breadcrumb2(props, ref) {
    ...
    const clones = validChildren.map(
      (child, index) => (0, import_react78.cloneElement)(child, {
        separator,
        spacing,
...
function useInitialAnimationState(isChecked) {
  const [previousIsChecked, setPreviousIsChecked] = (0, import_react87.useState)(isChecked);
  const [shouldAnimate, setShouldAnimate] = (0, import_react87.useState)(false);
...
function useFormControlProvider(props) {
  ...
  const [isFocused, setFocus] = (0, import_react88.useState)(false);
  const getHelpTextProps = (0, import_react88.useCallback)(
  ...
  const getErrorMessageProps = (0, import_react88.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      id: feedbackId,
      ...props2,
      /**
  ...
  const getRequiredIndicatorProps = (0, import_react88.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
      ref: forwardedRef,
      role: "presentation",
...
function useCheckbox(props = {}) {
  ...
  const [rootIsLabelElement, setRootIsLabelElement] = (0, import_react89.useState)(true);
  const [checkedState, setCheckedState] = (0, import_react89.useState)(!!defaultChecked);
  ...
  const getIndicatorProps = (0, import_react89.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
      ref: forwardedRef,
      "data-active": dataAttr(isActive),
...
var Checkbox = forwardRef(function Checkbox2(props, ref) {
  ...
  const iconStyles = (0, import_react90.useMemo)(
    () => ({
  ...
  const clonedIcon = (0, import_react90.cloneElement)(icon, {
    __css: iconStyles,
...
function useCounter(props = {}) {
  ...
  const onChangeProp = useCallbackRef(onChange);
  const [valueState, setValue] = (0, import_react91.useState)(() => {
    var _a2;
  ...
  const update = (0, import_react91.useCallback)(
    (next) => {
      if (next === value)
        return;
      if (!isControlled) {
  ...
  const clamp2 = (0, import_react91.useCallback)(
    (value2) => {
  ...
  const increment = (0, import_react91.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse(step);
  ...
  const decrement = (0, import_react91.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse(-step);
  ...
  const reset = (0, import_react91.useCallback)(() => {
    var _a2;
    let next;
    if (defaultValue == null) {
      next = "";
  ...
  const castValue = (0, import_react91.useCallback)(
    (value2) => {
      var _a2;
...
function useEditable(props = {}) {
  ...
  const [isEditing, setIsEditing] = (0, import_react93.useState)(defaultIsEditing);
  const [value, setValue] = useControllableState({
    defaultValue: defaultValue || "",
    value: valueProp,
    onChange: onChangeProp
  ...
  const editButtonRef = (0, import_react93.useRef)(null);
  const cancelButtonRef = (0, import_react93.useRef)(null);
  const submitButtonRef = (0, import_react93.useRef)(null);
  ...
  const onUpdatePrevValue = (0, import_react93.useCallback)(() => {
    setPrevValue(value);
  }, [value]);
  ...
  const onBlur3 = (0, import_react93.useCallback)(
    (event) => {
      var _a2;
      if (!isEditing)
        return;
  ...
  const getEditButtonProps = (0, import_react93.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Edit",
      ...props2,
      type: "button",
  ...
  const getSubmitButtonProps = (0, import_react93.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      "aria-label": "Submit",
  ...
  const getCancelButtonProps = (0, import_react93.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Cancel",
      id: "cancel",
      ...props2,
...
function useCallbackRef2(initialValue, callback) {
  var ref = (0, import_react94.useState)(function() {
    return {
      // value
      value: initialValue,
      // last callback
...
var InFocusGuard = function InFocusGuard2(_ref2) {
  ...
  return import_react95.default.createElement(import_react95.Fragment, null, import_react95.default.createElement("div", {
    key: "guard-first",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
  }), children, children && import_react95.default.createElement("div", {
    key: "guard-last",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
...
var focusScope = (0, import_react98.createContext)(void 0);

// node_modules/react-focus-lock/dist/es2015/Lock.js
var emptyArray = [];
var FocusLock = (0, import_react99.forwardRef)(function FocusLockUI(props, parentRef) {
  var _extends2;
  var _useState = (0, import_react99.useState)(), realObserved = _useState[0], setObserved = _useState[1];
  var observed = (0, import_react99.useRef)();
  var isActive = (0, import_react99.useRef)(false);
  var originalFocusedElement = (0, import_react99.useRef)(null);
  var _useState2 = (0, import_react99.useState)({}), update = _useState2[1];
  ...
  var _useState3 = (0, import_react99.useState)({}), id3 = _useState3[0];
  var onActivation = (0, import_react99.useCallback)(function(_ref2) {
  ...
  var onDeactivation = (0, import_react99.useCallback)(function() {
  ...
  var returnFocus = (0, import_react99.useCallback)(function(allowDefer) {
  ...
  var onFocus3 = (0, import_react99.useCallback)(function(event) {
    if (isActive.current) {
      mediumFocus.useMedium(event);
    }
  }, []);
  var onBlur3 = mediumBlur.useMedium;
  var setObserveNode = (0, import_react99.useCallback)(function(newObserved) {
  ...
  var focusScopeValue = (0, import_react99.useMemo)(function() {
    return {
      observed,
      shards,
      enabled: !disabled,
  ...
  return import_react99.default.createElement(import_react99.Fragment, null, hasLeadingGuards && [
    ...
    hasPositiveIndices ? import_react99.default.createElement("div", {
      key: "guard-nearest",
      "data-focus-guard": true,
      tabIndex: disabled ? -1 : 1,
      style: hiddenGuard
    }) : null
  ], !disabled && import_react99.default.createElement(SideCar2, {
    id: id3,
    ...
    focusOptions,
    noFocusGuards
  }), import_react99.default.createElement(Container3, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
    onFocus: onFocus3
  }), import_react99.default.createElement(focusScope.Provider, {
    value: focusScopeValue
  }, children)), hasTailingGuards && import_react99.default.createElement("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
...
// node_modules/react-focus-lock/dist/es2015/Combination.js
var FocusLockCombination = (0, import_react102.forwardRef)(function FocusLockUICombination(props, ref) {
  return import_react102.default.createElement(Lock_default, _extends({
...
var AutoFocusInside = function AutoFocusInside2(_ref2) {
  ...
  return import_react103.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !disabled), {
    className
  }), children);
};
...
function MoveFocusInside(_ref2) {
  ...
  var ref = (0, import_react104.useRef)(null);
  useFocusInside(isDisabled2 ? void 0 : ref);
  return import_react104.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled2), {
    ref,
    className
  }), children);
}
...
var FreeFocusInside = function FreeFocusInside2(_ref2) {
  ...
  return import_react105.default.createElement("div", _extends({}, inlineProp(FOCUS_ALLOW, true), {
    className
  }), children);
};
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react108.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react108.useCallback)(() => {
    var _a2;
...
var useSafeLayoutEffect3 = isBrowser ? import_react111.useLayoutEffect : import_react111.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react112 = __toESM(require_react(), 1);
function useCallbackRef3(fn2, deps = []) {
  const ref = (0, import_react112.useRef)(fn2);
  useSafeLayoutEffect3(() => {
    ref.current = fn2;
  });
  return (0, import_react112.useCallback)((...args) => {
    var _a2;
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react114.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react119.useRef)();
...
function useId6(idProp, prefix) {
  const id3 = (0, import_react123.useId)();
...
function useOptionalPart(partId) {
  const [id3, setId] = (0, import_react123.useState)(null);
  const ref = (0, import_react123.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react124.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react124.useCallback)(
    (next) => {
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react127.useRef)(false);
  const effectCycleRef = (0, import_react127.useRef)(false);
...
function useForceUpdate2() {
  const unloadingRef = (0, import_react129.useRef)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react131.useState)(initialState2);
  const callbacks = (0, import_react131.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react132.useState)(false);
  const [valueState, setValueState] = (0, import_react132.useState)(value);
  (0, import_react132.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react132.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react134.useState)(null);
  const rafId = (0, import_react134.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react136.useMemo)(
    () => shouldWrapChildren ? import_react136.Children.map(children, (child, index) => (0, import_jsx_runtime82.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react137.useMemo)(
    () => getDividerStyles({ spacing, direction }),
    [spacing, direction]
  );
  const hasDivider = !!divider;
  const shouldUseChildren = !shouldWrapChildren && !hasDivider;
  const clones = (0, import_react137.useMemo)(() => {
    const validChildren = getValidChildren(children);
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react137.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime85.jsxs)(import_react137.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useHighlight(props) {
  ...
  return (0, import_react138.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime91.jsx)(import_jsx_runtime91.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime91.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime91.jsx)(import_react138.Fragment, { children: chunk.text }, index);
  }) });
}
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react142.useState)([]);
  const timeoutRef = (0, import_react142.useRef)();
  const flush = () => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
  ...
  (0, import_react142.useEffect)(() => flush, []);
  function onKeyDown(fn2) {
    return (event) => {
      if (event.key === "Backspace") {
        const keysCopy = [...keys];
...
function useEventListeners() {
  ...
  const currentListeners = listeners.current;
  const add = (0, import_react143.useCallback)((el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react144.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react144.useState)(false);
  ...
  const trulyDisabled = isDisabled2 && !isFocusable2;
  const handleClick = (0, import_react144.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.stopPropagation();
        event.preventDefault();
  ...
  const onDocumentKeyUp = (0, import_react144.useCallback)(
    (e) => {
  ...
  const handleKeyUp = (0, import_react144.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react144.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react144.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled2) {
  ...
  const handleMouseUp = (0, import_react144.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react144.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react144.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react146.useRef)(null);
  const popper2 = (0, import_react146.useRef)(null);
  const instance = (0, import_react146.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction);
  const cleanup = (0, import_react146.useRef)(() => {
  });
  const setupPopper = (0, import_react146.useCallback)(() => {
    var _a2;
  ...
  const referenceRef = (0, import_react146.useCallback)(
    (node2) => {
  ...
  const getReferenceProps = (0, import_react146.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react146.useCallback)(
    (node2) => {
  ...
  const getPopperProps = (0, import_react146.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react146.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react146.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure2(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react147.useState)(props.defaultIsOpen || false);
  const isOpen = isOpenProp !== void 0 ? isOpenProp : isOpenState;
  const isControlled = isOpenProp !== void 0;
  const uid = (0, import_react147.useId)();
  ...
  const onToggle = (0, import_react147.useCallback)(() => {
    if (isOpen) {
      onClose();
    } else {
      onOpen();
...
function useAnimationState2(props) {
  const { isOpen, ref } = props;
  const [mounted, setMounted] = (0, import_react149.useState)(isOpen);
  const [once, setOnce] = (0, import_react149.useState)(false);
...
function useMenu(props = {}) {
  ...
  const rafId = (0, import_react150.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id3 = `${menuId}-menuitem-${(0, import_react150.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled2 && !isFocusable2
  });
  const onMouseEnter = (0, import_react150.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react150.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react150.useCallback)(
    (event) => {
  ...
  const onClick = (0, import_react150.useCallback)(
    (event) => {
  ...
  const onFocus3 = (0, import_react150.useCallback)(
    (event) => {
...
var ModalTransition = (0, import_react154.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react155.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react156.useRef)(null);
  const overlayRef = (0, import_react156.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react156.useRef)(null);
  const onMouseDown = (0, import_react156.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react156.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react156.useState)(false);
  const getDialogProps = (0, import_react156.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react156.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react156.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react162.useState)(false);
  const [action, setAction] = (0, import_react162.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react162.useState)(true);
  const timeoutRef = (0, import_react162.useRef)(null);
  ...
  const up = (0, import_react162.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react162.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react162.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const inputRef = (0, import_react163.useRef)(null);
  const inputSelectionRef = (0, import_react163.useRef)(null);
  const incrementButtonRef = (0, import_react163.useRef)(null);
  const decrementButtonRef = (0, import_react163.useRef)(null);
  const sanitize2 = (0, import_react163.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse3 = (0, import_react163.useCallback)(
    (value) => {
      var _a2;
  ...
  const format = (0, import_react163.useCallback)(
    (value) => {
      var _a2;
  ...
  const increment = (0, import_react163.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react163.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const _onFocus = (0, import_react163.useCallback)(
    (event) => {
      var _a2, _b, _c;
  ...
  const ariaValueText = (0, import_react163.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react163.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react163.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  }, [clampValueOnBlur, setFocused, validateAndClamp]);
  const focusInput = (0, import_react163.useCallback)(() => {
  ...
  const spinUp = (0, import_react163.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react163.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react163.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react163.useCallback)(
    (props2 = {}, ref = null) => {
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react164.useMemo)(() => context, [context]);
...
function usePinInput(props = {}) {
  ...
  const [moveFocus2, setMoveFocus] = (0, import_react165.useState)(true);
  const [focusedIndex, setFocusedIndex] = (0, import_react165.useState)(-1);
  ...
  const focusNext = (0, import_react165.useCallback)(
    (index) => {
  ...
  const setValue = (0, import_react165.useCallback)(
  ...
  const clear = (0, import_react165.useCallback)(() => {
    var _a2;
  ...
  const getNextValue = (0, import_react165.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react166.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  const child = import_react167.Children.only(props.children);
  const { getTriggerProps } = usePopoverContext();
  return (0, import_react167.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react168.useRef)(null);
  const triggerRef = (0, import_react168.useRef)(null);
  const popoverRef = (0, import_react168.useRef)(null);
  const isHoveringRef = (0, import_react168.useRef)(false);
  const hasBeenOpened = (0, import_react168.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react168.useState)(false);
  const [hasBody, setHasBody] = (0, import_react168.useState)(false);
  ...
  const getPopoverProps = (0, import_react168.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react168.useCallback)(
  ...
  const getAnchorProps = (0, import_react168.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react168.useRef)();
  const closeTimeout = (0, import_react168.useRef)();
  const maybeReferenceRef = (0, import_react168.useCallback)(
    (node2) => {
  ...
  const getHeaderProps = (0, import_react168.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react168.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node2) => {
...
function PopoverAnchor(props) {
  ...
  return (0, import_react169.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react170.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react170.useRef)(null);
  const focus2 = (0, import_react170.useCallback)(() => {
  ...
  const getRadioProps = (0, import_react170.useCallback)(
    (props2 = {}, ref2 = null) => {
      const checkedKey = isNative ? "checked" : "isChecked";
      return {
        ...props2,
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react171.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react172.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react172.useState)(false);
  const [isFocused, setFocused] = (0, import_react172.useState)(false);
  const [isHovered, setHovering] = (0, import_react172.useState)(false);
  const [isActive, setActive] = (0, import_react172.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react172.useState)(Boolean(defaultChecked));
  ...
  const onKeyUp = (0, import_react172.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react173.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime146.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react173.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react174.useRef)(true);
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react177.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react178.useLayoutEffect : import_react178.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react178.useState)([]);
  const [count, setCount] = (0, import_react178.useState)(0);
...
function useRangeSlider(props) {
  ...
  const isVertical = orientation === "vertical";
  const trackRef = (0, import_react179.useRef)(null);
  const rootRef = (0, import_react179.useRef)(null);
  ...
  const reactId = (0, import_react179.useId)();
  const uuid = idProp != null ? idProp : reactId;
  const ids = getIds(uuid);
  const getValueFromPointer = (0, import_react179.useCallback)(
    (event) => {
      var _a2, _b;
      if (!trackRef.current)
        return;
  ...
  const actions = (0, import_react179.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react179.useMemo)(
    () => getStyles3({
      isReversed,
      orientation,
      thumbRects,
  ...
  const focusThumb = (0, import_react179.useCallback)(
    (index) => {
      var _a2;
  ...
  const getRootProps = (0, import_react179.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ...htmlProps,
  ...
  const getTrackProps = (0, import_react179.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getInnerTrackProps = (0, import_react179.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react179.useCallback)(
    (props2, ref = null) => {
      var _a2;
      const { index, ...rest } = props2;
  ...
  const getOutputProps = (0, import_react179.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getMarkerProps = (0, import_react179.useCallback)(
    (props2, ref = null) => {
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react180.useMemo)(
...
function useSlider(props) {
  ...
  const [isDragging2, setDragging] = (0, import_react181.useState)(false);
  ...
  const thumbRef = (0, import_react181.useRef)(null);
  ...
  const constrain = (0, import_react181.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  const stepElements = import_react182.Children.toArray(children);
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react183.useState)(index);
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react184.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react184.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react184.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react185.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react185.createElement)(
      TabPanelProvider,
      {
        key: index,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react185.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react185.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react185.useState)(false);
  useSafeLayoutEffect(() => {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  const context = (0, import_react186.useMemo)(() => ctx, [ctx]);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react187.useRef)();
  const clearEnterTimeout = (0, import_react187.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react187.useRef)();
  const clearExitTimeout = (0, import_react187.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react187.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react187.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react187.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
    exitTimeout.current = win.setTimeout(closeNow, closeDelay);
  }, [closeDelay, closeNow, clearEnterTimeout]);
  const onClick = (0, import_react187.useCallback)(() => {
    if (isOpen && closeOnClick) {
      closeWithDelay();
    }
  }, [closeOnClick, closeWithDelay, isOpen]);
  const onPointerDown = (0, import_react187.useCallback)(() => {
  ...
  const getTriggerProps = (0, import_react187.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getTooltipPositionerProps = (0, import_react187.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react187.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  if (shouldWrap) {
    ...
    const child = import_react188.Children.only(children);
    trigger2 = (0, import_react188.cloneElement)(
      child,
