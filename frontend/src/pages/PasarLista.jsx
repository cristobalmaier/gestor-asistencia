    ...
    <div className="space-y-6">
      ...
      {alumnos.length > 0 && (
        <div className="flex justify-end gap-3">
          ...
          <button 
            onClick={guardar} 
            className={`inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors shadow-sm ${
              isEditing 
